...
def get_args() -> dict:
    ...
    # path
    parser.add_argument('--inputs_path', type=str, default='../../outputs/')
    parser.add_argument('--nc_data_path', type=str, default='../../adhub/LandBench2/0.1/')#adhub
    parser.add_argument('--product', type=str, default='')
    parser.add_argument('--workname', type=str, default='LandBench')
    parser.add_argument('--modelname', type=str, default='TimeNetModel')# Process;Persistence;w_climatology;LSTM;ConvLSTM;CNN;TimeNetModel
    ...
    # data
    parser.add_argument('--selected_year', nargs='+', type=int, default=[1979,2020])
    ...
    parser.add_argument('--land_surface_list', nargs='+', type=str, default=["surface_solar_radiation_downwards_w_m2","surface_thermal_radiation_downwards_w_m2","soil_temperature_level_1"])
          ...
          # static SSHF: ["soil_water_capacity"]p
    ...
    parser.add_argument('--forcast_time', type=float, default=7)
